...
## What do you need?[¶](#what-do-you-need "Permalink to this headline")
...
The typical configuration of this equipment is summarized in [Figure 1](#fig-overview).

![overview](_images/overview_label.png)

Figure 1 Setup overview

## Preparing your computer[¶](#preparing-your-computer "Permalink to this headline")
...
5.  Install the EV3 MicroPython extension as shown in [Figure 2](#fig-store).

![store](_images/store_label.png)

Figure 2 Installing the extension from the Visual Studio Code marketplace

## Preparing the microSD card[¶](#preparing-the-microsd-card "Permalink to this headline")
...
If the microSD card contains files you want to keep, make sure to create a backup of its contents first. See [managing files on the EV3](startrun.html#managefiles) to learn how to backup your previous MicroPython programs if necessary.

_This process erases everything on your microSD card, including any previous MicroPython programs on it._
...
4.  Launch the flashing tool and follow the steps on your screen to install the file you have just downloaded. If you use Etcher, you can follow the instructions below, as shown in [Figure 3](#fig-etcher).
...
![etcher](_images/etcher_label.png)

Figure 3 Using Etcher to flash the EV3 MicroPython microSD card image

## Updating the microSD card[¶](#updating-the-microsd-card "Permalink to this headline")

To update the microSD card, download a new image file using the link above and flash it to the microSD card as described above. Be sure to [back up any MicroPython programs you want to save](startrun.html#managefiles).
